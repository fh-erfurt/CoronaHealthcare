...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 12. Feb 2021 um 20:46
...
INSERT INTO `address` (`id`, `zip`, `street`, `number`, `city`) VALUES
(1, '99096', 'Freiligrathstraße', '5B', 'Erfurt');
...
--
-- Tabellenstruktur für Tabelle `orderproductmapping`
--
...
CREATE TABLE `product` (
  ...
  `description` varchar(255) DEFAULT 'Zu diesem Produkt gibt es noch keine Beschreibung.',
  `picturepath` varchar(255) DEFAULT 'Kein Bild angegeben',
...
INSERT INTO `profile` (`id`, `createdAt`, `firstname`, `lastname`, `phone`, `email`, `address`, `password`) VALUES
(1, '2021-01-20 15:13:08', 'Marvin', 'Ruppert', '01735929818', 'MarvinRuppert2@gmx.de', 1, '123456789'),
(2, '2021-01-20 15:14:49', 'Marvin', 'Ruppert', '2050', 'Marvin.Ruppert@on-geo.de', 1, '123456789');
...
ALTER TABLE `order`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_order_profil1_idx` (`profile`);

--
-- Indizes für die Tabelle `orderhistory`
--
ALTER TABLE `orderhistory`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_orderHistory_order1_idx` (`order`);

--
-- Indizes für die Tabelle `orderproductmapping`
--
ALTER TABLE `orderproductmapping`
  ADD PRIMARY KEY (`product_id`,`order_id`),
  ADD KEY `fk_product_has_order_order1_idx` (`order_id`),
  ADD KEY `fk_products_has_order_product1_idx` (`product_id`);
...
ALTER TABLE `profile`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_profile_adress_idx` (`address`);
...
--
-- AUTO_INCREMENT für Tabelle `orderhistory`
--
ALTER TABLE `orderhistory`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `fk_order_profile1` FOREIGN KEY (`profile`) REFERENCES `profile` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints der Tabelle `orderhistory`
--
ALTER TABLE `orderhistory`
  ADD CONSTRAINT `fk_orderHistory_order1` FOREIGN KEY (`order`) REFERENCES `order` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints der Tabelle `orderproductmapping`
--
ALTER TABLE `orderproductmapping`
  ADD CONSTRAINT `fk_products_has_order_order1` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_products_has_order_products1` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `profile`
  ADD CONSTRAINT `fk_profile_adress` FOREIGN KEY (`address`) REFERENCES `address` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
